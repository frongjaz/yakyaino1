...
const faqs = [
  {
    ...
    a: "ขายรถให้ CheckKub ได้เลย เรารับซื้อรถทุกประเภท ประเมินราคารวดเร็วภายใน 24 ชั่วโมง ชำระเงินภายใน 1–3 วันทำการ ไม่มีค่าใช้จ่าย รับซื้อทั่วประเทศ",
  },
  {
    q: "ต้องการขายรถต้องทำอย่างไร?",
    a: "ส่งรูปและข้อมูลรถมาที่ CheckKub ผ่าน LINE, Facebook หรือเว็บไซต์ ทีมงานจะประเมินราคาและติดต่อกลับภายใน 24 ชั่วโมง หากตกลงราคาได้จะนัดตรวจสภาพและโอนเงินภายใน 1–3 วันทำการ",
  },
  {
