          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-base leading-relaxed text-white/90 md:text-lg md:leading-8">
                ...
                <p className="text-left">
                  เรามีทีมผู้เชี่ยวชาญตรวจสภาพรถอย่างมืออาชีพ พร้อมชำระเงินภายใน 1–3 วันทำการหลังตกลง
                  ราคาและดำเนินเอกสารครบถ้วน ไม่ต้องทำขั้นตอนยุ่งยาก นอกจากนี้ เรายังดูแลเรื่อง
                  เอกสารทั้งหมด ตั้งแต่สัญญาซื้อขาย การปิดไฟแนนซ์ ไปจนถึงการโอน
                  กรรมสิทธิ์ให้เสร็จสิ้น เพื่อให้ลูกค้าสบายใจและประหยัดเวลา
                </p>
                <p className="text-left">
                  ด้วยประสบการณ์ในธุรกิจยานยนต์มายาวนาน เราเข้าใจทุกขั้นตอนของการซื้อ
