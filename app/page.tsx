...
export const metadata: Metadata = {
  ...
  description:
    "ต้องการขายรถ? รับซื้อรถ? CheckKub รับซื้อรถทุกประเภท รถมือสอง รถบริษัท และฟลีตรถทั่วประเทศ. ขายรถให้เรา ประเมินรวดเร็ว ราคายุติธรรม ชำระเงินภายใน 1–3 วันทำการ.",
  keywords: [
    "ขายรถ",
    "รับซื้อรถ",
    "ต้องการขายรถ",
  ...
  twitter: {
    ...
    description:
      "ต้องการขายรถ? รับซื้อรถ? CheckKub รับซื้อรถทุกประเภท ประเมินรวดเร็ว ราคายุติธรรม ชำระเงินภายใน 1–3 วันทำการ.",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "ขายรถให้ CheckKub ได้เลย เรารับซื้อรถทุกประเภท ประเมินราคารวดเร็วภายใน 24 ชั่วโมง ชำระเงินภายใน 1–3 วันทำการ ไม่มีค่าใช้จ่าย รับซื้อทั่วประเทศ",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "ส่งรูปและข้อมูลรถมาที่ CheckKub ผ่าน LINE, Facebook หรือเว็บไซต์ ทีมงานจะประเมินราคาและติดต่อกลับภายใน 24 ชั่วโมง หากตกลงราคาได้จะนัดตรวจสภาพและโอนเงินภายใน 1–3 วันทำการ",
        },
      },
      {
        "@type": "Question",
  ...
  const structuredData = [
    {
      ...
      name: "CheckKub",
      url: baseUrl,
      description: "CheckKub รับซื้อรถทุกประเภท ประเมินรวดเร็ว ราคายุติธรรม ชำระเงินภายใน 1–3 วันทำการ",
      inLanguage: "th-TH",
      potentialAction: {
        "@type": "SearchAction",
        target: {
