...
export default function CarDetailError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center px-4 text-center">
      <h2 className="mb-4 text-2xl font-bold text-dark dark:text-white">ไม่สามารถโหลดข้อมูลรถคันนี้ได้</h2>
