...
export const metadata: Metadata = {
  ...
  description:
    "CheckKub ผู้เชี่ยวชาญด้านการรับซื้อรถและขายรถมือสองคุณภาพดี. ทีมงานมืออาชีพพร้อมประเมินราคายุติธรรม ชำระเงินภายใน 1–3 วันทำการ ดูแลเอกสารครบจบในที่เดียว.",
  keywords: [
    "เกี่ยวกับ CheckKub",
    "ขายรถ",
    "รับซื้อรถ",
  ...
  openGraph: {
    ...
    description:
      "CheckKub ผู้เชี่ยวชาญด้านการรับซื้อรถและขายรถมือสองคุณภาพดี ประเมินราคายุติธรรม ชำระเงินภายใน 1–3 วันทำการ",
